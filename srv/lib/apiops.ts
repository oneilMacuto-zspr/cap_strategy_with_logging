const { ApplicationLogger } = require("./application_logging_one_instance"); // for class-based functions
const performanceLog = new ApplicationLogger("apiops"); // for class-based functions
